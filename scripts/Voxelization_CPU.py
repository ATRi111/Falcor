...
def render_graph_Pass():
    ...
    g.addEdge("ReadVoxelPass.ellipsoid","RayMarchingPass.ellipsoid")
    g.addEdge("ReadVoxelPass.NDFLobes","RayMarchingPass.NDFLobes")
    g.addEdge("ReadVoxelPass.visibilitySH","RayMarchingPass.visibilitySH")
    g.addEdge("ReadVoxelPass.polygonAreaSH","RayMarchingPass.polygonAreaSH")
